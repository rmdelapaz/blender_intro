...
**Total Size:** ~13+ MB and growing. Lesson 01 at 118.3 KB; Lesson 02 at 148.8 KB; Lesson 03 at 231.8 KB (integration complete); Lesson 04 at 229.2 KB (integration complete). Image production has shipped assets for Lessons 01 through 04 into `images/`. Per-lesson production-chat history and rolled-up Lesson 03 detail live in `status_archive.md` plus the per-lesson `lesson_NN_integration_progress.md` files.
...
| 05 Understanding Meshes and Geometry | 0 of 30 | 0 of 30 | 🚧 In Progress | Planning chat 2026-05-19 wrote `lesson_05_integration_progress.md` with locked phase plan: 6 phases distributed `4 / 4 / 5 / 6 / 5 / 6` by HTML section (`#what-are-meshes`, `#mesh-components`, `#mesh-density` plus `#normals`, `#polygon-types`, `#topology`, `#manifold-geometry` plus `#summary`); 15 SVGs plus 15 PNGs split (extends the requirements doc's 9 explicit SVG candidates to follow the locked house-style precedent from Lessons 03 and 04). Image production has not started. HTML at 82.4 KB (84327 bytes). Projected final approximately 310 to 340 KB; this is the largest image-integration lesson in the project to date. Phase 1 (`#what-are-meshes`, four all-SVG inserts: #1 mc, #2 lp, #3 mo, #4 pt) is the next pass. See `lesson_05_integration_progress.md`. |
| 06 to 51 | not started | n/a | ⏳ Pending | Image requirements docs exist for every lesson (`lesson_NN_image_requirements*.md`). |
...
- `lesson_05_integration_progress.md`: Lesson 05 image integration plan and current state (planning complete; 0 of 30 produced, 0 of 30 integrated; HTML at 82.4 KB)
