...
**Total Size:** ~13+ MB and growing. Lesson 01 at 118.3 KB; Lesson 02 at 148.8 KB; Lesson 03 at 231.8 KB (integration complete); Lesson 04 at 215.6 KB (integration in progress). Image production has shipped assets for Lessons 01 through 03 plus partial Lesson 04 into `images/`. Per-lesson production-chat history and rolled-up Lesson 03 detail live in `status_archive.md` plus the per-lesson `lesson_NN_integration_progress.md` files.
...
| 4 | Basic Object Manipulation | `lesson_04_basic_object_manipulation.html` | 215.6 KB | ✅ | ✅ | ✅ |
...
- `lesson_04_integration_progress.md`: Lesson 04 image integration plan, current state (Phases 1, 2, 3, 4, and 5 integrated; 12 of 14 images produced or captured, 12 of 14 integrated; HTML at 215.6 KB), and locked approach
