...
**SVG BATCHES (own fresh chat).** 3 remain (#14&#8211;#16), batches of 3, per §SVG plan-lock loop. Read §Roster triage registry for slugs/anchors + §SVG build log for what's done. Integration = separate later phase once 16/16 built.
